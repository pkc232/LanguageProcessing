...
{
  "$end", "error", "$undefined", "print", "if", "else", "then",
  "exit_command", "number", "ID", "'+'", "'-'", "'*'", "'/'", "';'", "'='",
...
{
      16,    -7,    -6,    -2,     3,     0,    -9,    -9,    17,    -9,
      -9,    -7,    -9,    -7,    10,    -2,    12,    22,    -9,    -7,
      -7,    -7,    -7,    -9,    32,    27,    -9,    -9,    -9,     9,
      -8,    33,    -9,    -9
};
...
{
       0,     0,     0,     0,     0,     0,    16,    15,     0,    14,
       7,     0,     1,     0,     0,    15,     0,     0,     2,     0,
       0,     0,     0,     3,     9,     0,     8,     5,     4,    10,
      11,    12,    13,     6
};
...
{
      17,     6,     7,    12,    21,    22,    13,    24,    10,    25,
      14,     6,    15,    11,    18,    29,    30,    31,    32,     1,
      20,    21,    22,     2,    26,     3,    27,    19,    20,    21,
      22,    23,    19,    20,    21,    22,    28,    19,    20,    21,
      22,    33,    19,    20,    21,    22,    22,    16
};

static const yytype_uint8 yycheck[] =
{
       4,     8,     9,     0,    12,    13,     3,    11,    14,    13,
       7,     8,     9,    15,    14,    19,    20,    21,    22,     3,
      11,    12,    13,     7,    14,     9,    14,    10,    11,    12,
      13,    14,    10,    11,    12,    13,    14,    10,    11,    12,
      13,    14,    10,    11,    12,    13,    13,     4
};
...
{
       0,     3,     7,     9,    17,    18,     8,     9,    19,    20,
      14,    15,     0,     3,     7,     9,    18,    19,    14,    10,
      11,    12,    13,    14,    19,    19,    14,    14,    14,    19,
      19,    19,    19,    14
};
...
#line 39 "simple.y" /* yacc.c:1646  */
    {string s((yyvsp[-2].id));table[s]=(yyvsp[0].num);}
...
#line 51 "simple.y" /* yacc.c:1646  */
    {string s((yyvsp[0].id));(yyval.num)=table[s];}
